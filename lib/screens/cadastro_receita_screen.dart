...
class _CadastroReceitaScreenState extends State<CadastroReceitaScreen>
  ...
  Future<void> _salvarReceita() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (erro != null) {
        ScaffoldMessenger.of(context).showSnackBar(
          _buildSnack('Erro ao cadastrar receita: $erro',
              cor: AppColors.vermelho),
        );
        return;
      }
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        _buildSnack('Receita cadastrada com sucesso!', cor: AppColors.verde),
      );
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _animar(
                          0,
                          _buildCard(
                            child: _buildCampoNome(),
                          ),
                        ),
                        const SizedBox(height: 16),
                        _animar(
                          1,
                          _buildCard(child: _buildSeletorAcesso()),
                        ),
                        const SizedBox(height: 16),
                        _animar(
                          2,
                          _buildCard(child: _buildSecaoImagens()),
                        ),
                        const SizedBox(height: 16),
                        _animar(
                          3,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  'Preencha os campos abaixo para compartilhar sua receita',
                  style: TextStyle(
